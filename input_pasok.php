                ...
                <table align="center" border="1" class="mt-4 table table-striped table-hover bg-white" id="tableAll">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="?menu=input_pasok&edit&id=<?php echo $r['id_pasok']?>"class="btn btn-warning">Edit</a></td>
                            <td><a href="?menu=input_pasok&hapus&id=<?php echo $r['id_pasok']?>"class="btn btn-danger" onclick="return confirm('Hapus Data?')">Hapus</a></td>
                        </tr>
                        <?php } ?> 
                    </tbody>
                </table>
